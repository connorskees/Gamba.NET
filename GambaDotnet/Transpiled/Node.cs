...
namespace Gamba.Prototyping.Transpiled
{
    ...
    public class Node
    {
        ...
        public string to_string(bool withParentheses = false, int end = -(1), List<string> varNames = null)
        {
            ...
            else if ((this.type) == (NodeType.EXCL_DISJUNCTION))
            {
                Assert.True((this.children.Count()) > (0));
                child1 = this.children[0];
        ...
        public long eval(List<long> X)
        {
            if ((this.type) == (NodeType.CONSTANT))
            {
                return Mod(this.constant, this.__modulus);
            }
            ...
            if ((this.type) == (NodeType.VARIABLE))
            {
                ...
                return Mod(X[this.__vidx], this.__modulus);
            }

            Assert.True((this.children.Count()) > (0));
            if ((this.type) == (NodeType.NEGATION))
            {
                return Mod(~(this.children[0].eval(X)), this.__modulus);
            }
            ...
            {
                val = Mod(this.__apply_binop(val, this.children[i].eval(X)), this.__modulus);
            }
        ...
        public void __inspect_constants()
        {
            ...
            else if ((this.type) == (NodeType.CONJUNCTION))
            {

                this.__inspect_constants_conjunction();
            }
            else if ((this.type) == (NodeType.SUM))
            {

                this.__inspect_constants_sum();
            }
            else if ((this.type) == (NodeType.PRODUCT))
            {

                this.__inspect_constants_product();
            }
            else if ((this.type) == (NodeType.NEGATION))
            {

                this.__inspect_constants_negation();
            }
            else if ((this.type) == (NodeType.POWER))
            {

                this.__inspect_constants_power();
            }
            else if ((this.type) == (NodeType.CONSTANT))
            {
        ...
        public void __flatten_product()
        {
            ...
            while ((i) < (this.children.Count()))
            {
                ...
                this.children.InsertRange(i, child.children);
        ...
        {
            if ((Mod(((factor) - (1)), this.__modulus)) == (0))
            {
                return;
            }
            ...
            if ((this.type) == (NodeType.PRODUCT))
            {
                ...
                if ((this.children[0].type) == (NodeType.PRODUCT))
                {
                    ...
                    this.children.InsertRange(1, this.children[0].children.Slice(1, null, null));
                ...
                if ((this.children[0].type) == (NodeType.CONSTANT))
                {
                    ...
                    else if (this.children[0].__is_constant(0))
                    {
        ...
        public bool __check_bitwise_powers_of_two()
        {
            ...
            foreach (var child in this.children)
            {
                ...
                else if ((this.type) == (NodeType.INCL_DISJUNCTION))
                {
                    add |= rem;
                }
                else
        ...
        public void __decrement_exponent()
        {
            ...
            else if (this.children[1].__is_constant(0))
            {
        ...
        public void __multiply_power_with_power(Node other)
        {
            ...
            if (this.children[0].equals(other.children[0]))
            {
                ...
                else if (this.children[1].__is_constant(1))
                {
        ...
        public bool __check_expand_power()
        {
            ...
            var exp = Mod(expNode.constant, this.__modulus);
        ...
        public (List<Node>, List<(int, HashSet<IndexWithMultitude>)>, List<HashSet<IndexWithMultitude>>) __collect_all_factors_of_sum()
        {
            ...
            foreach (var i in Range.Get(this.children.Count()))
            {
                HashSet<IndexWithMultitude> idwSet = new() { };
                termsToNodes.Add(idwSet);
        ...
        public void __collect_factors_of_power(int i, long multitude, List<Node> nodes, List<(int, HashSet<IndexWithMultitude>)> nodesToTerms, List<HashSet<IndexWithMultitude>> termsToNodes)
        {
            ...
            if ((exp.type) == (NodeType.CONSTANT))
            {
                _base.__collect_factors(i, Mod(((exp.constant) * (multitude)), this.__modulus), nodes, nodesToTerms, termsToNodes);
                return;
            }
            ...
            if ((exp.type) == (NodeType.SUM))
            {
                ...
                if ((first.type) == (NodeType.CONSTANT))
                {
                    _base.__collect_factors(i, Mod(((first.constant) * (multitude)), this.__modulus), nodes, nodesToTerms, termsToNodes);
        ...
        public void __check_store_factor(int i, long multitude, List<Node> nodes, List<(int, HashSet<IndexWithMultitude>)> nodesToTerms, List<HashSet<IndexWithMultitude>> termsToNodes)
        {
            ...
            if ((idx) == (null))
            {
                ...
                List<IndexWithMultitude> idws = new() { new IndexWithMultitude(i, multitude) };
                HashSet<IndexWithMultitude> idwsSet = new(idws) { };

                nodesToTerms.Add((((nodes.Count()) - (1)), idwsSet));
        ...
        public Node __divided(int divisor)
        {
            if ((this.type) == (NodeType.CONSTANT))
            {
                if ((Mod(this.constant, divisor)) == (0))
                {
        ...
        public NullableI32 __check_transform_bitwise_for_comb(bool toXor, int idx, Node bitw, long factor, Node opSum, int combIdx)
        {
            ...
            {
                Assert.True((Mod(this.__modulus, 2)) == (0));
            ...
            foreach (var pair in l)
            {
                ...
                foreach (var i in Range.Get(((sublist.Count()) - (1)), 0, -(1)))
                {
                    ...
                    foreach (var j in Range.Get(0, i))
                    {
                        ...
                        var firstConst = Mod(first.children[0].constant, this.__modulus);
                        var secConst = Mod(second.children[0].constant, this.__modulus);
        ...
        public (NullableI64, Node) __get_factor_of_bitw_with_constant(NodeType? expType = null)
        {
            ...
            else if ((this.children[0].type) != (NodeType.CONSTANT))
            {
                return (null, null);
            }
            else if (!(this.children[1].__is_bitwise_binop()))
            {
                return (null, null);
            }
            else if ((((expType) != (null)) && ((this.children[1].type) != (expType))))
            {
                return (null, null);
            }
            else
        ...
        public List<List<(long, int)>> __collect_all_indices_of_bitw_with_constants()
        {
            ...
            foreach (var i in Range.Get(this.children.Count()))
            {
                ...
                foreach (var sublist in l)
                {
                    ...
                    else if ((first.children.Count()) == (2))
                    {
                    ...
                    else if (!(do_children_match(first.children.Slice(1, null, null), node.children.Slice(1, null, null))))
                    {
        ...
        public NullableI64 __get_factor_for_merging_bitwise(long fac1, long fac2, NodeType type1, NodeType type2)
        {
            if ((type1) == (type2))
            {
                if ((Mod(((fac1) - (fac2)), this.__modulus)) != (0))
                {
                    return null;
                }
                return fac1;
            ...
            if ((type1) == (NodeType.EXCL_DISJUNCTION))
            {
                ...
                {
                    if ((Mod(((((2) * (fac1))) + (fac2)), this.__modulus)) != (0))
                    {
                        return null;
                    }
                }
                else if ((Mod(((((2) * (fac1))) - (fac2)), this.__modulus)) != (0))
                {
            ...
            if ((type1) == (NodeType.CONJUNCTION))
            {
                ...
                {
                    if ((Mod(((fac1) + (((2) * (fac2)))), this.__modulus)) != (0))
                    {
                        return null;
                    }
                }
                else if ((Mod(((fac1) + (fac2)), this.__modulus)) != (0))
                {
        ...
        public NullableI64 __try_merge_triple_bitwise_with_constants(List<(long, int)> sublist, int i, int j, int k, List<int> toRemove)
        {
            ...
            foreach (var perm in perms)
            {
                ...
                var mainConst = Mod(main.children[0].constant, this.__modulus);
                ...
                var opfac = Mod(((opfac1) + (opfac2)), this.__modulus);
        ...
        public (NullableI64, NullableI64) __get_factors_for_merging_triple(NodeType type1, NodeType type2, NodeType type0, long fac1, long fac2, long fac0, long const1, long const2, long const0)
        {
            ...
            if ((Mod(((((factor1) + (factor2))) - (fac0)), this.__modulus)) != (0))
            {
                return (null, null);
            }
        ...
        public (int, int)? __get_only_differing_child_indices_diff_len(Node other)
        {
            ...
            foreach (var i in nums)
            {
                ...
                var slice1 = ((other.children.Slice(null, idx, null)));
                var slice2 = (other.children.Slice(((idx) + (1)), null, null));
                if (!(do_children_match(this.children[oi].children, slice1.Concat(slice2).ToList())))
                {
                    continue;
                }
        ...
        public void __mark_linear_product()
        {
            ...
            else if ((((this.children[0].type) == (NodeType.CONSTANT)) && (this.children[1].is_linear())))
            {

                this.state = NodeState.LINEAR;
            }
            else if ((((this.children[1].type) == (NodeType.CONSTANT)) && (this.children[0].is_linear())))
            {
        ...
        public void __resolve_bitwise_negations_in_sums()
        {
            ...
            var negConst = Mod(-(this.children[0].constant), this.__modulus);
